...
export const CLASSES: Record<ClassId, ClassDef> = {
 ...
 abilities: {
 basic: { name: 'Fendente', description: 'Colpo frontale. Genera 12 rabbia quando colpisce.', cost: 0, cooldown: 0.55, range: 76, damage: 22, kind: 'melee', targeting: 'directional', radius: 76, color: '#ffd0a0' },
 q: { name: 'Spaccaterra', description: 'Un pesante colpo a cono davanti a te.', cost: 25, cooldown: 3, range: 105, damage: 42, kind: 'melee', targeting: 'directional', radius: 105, color: '#f7b278' },
 e: { name: 'Carica', description: 'Scatto direzionale di 180 unità. Si ferma sugli ostacoli.', cost: 0, cooldown: 7, range: 180, damage: 18, kind: 'dash', targeting: 'directional', radius: 35, color: '#ffddab' },
 r: { name: 'Turbine', description: 'Colpisce tutti i nemici nelle vicinanze.', cost: 50, cooldown: 10, range: 120, damage: 50, kind: 'area', targeting: 'self', radius: 120, color: '#f39a71' }
 } },
 ...
 abilities: {
 basic: { name: 'Colpo sacro', description: 'Colpo frontale con il martello.', cost: 0, cooldown: 0.65, range: 82, damage: 21, kind: 'melee', targeting: 'directional', radius: 82, color: '#f6df93' },
 q: { name: 'Giudizio', description: 'Un proiettile di luce che ferisce i nemici.', cost: 20, cooldown: 3.5, range: 410, damage: 30, kind: 'projectile', targeting: 'directional', speed: 380, radius: 11, color: '#ffe5a1' },
 e: { name: 'Luce vitale', description: 'Ripristina 38 salute a te e agli alleati del team entro il cerchio.', cost: 30, cooldown: 8, range: 135, damage: 38, kind: 'heal', targeting: 'self', radius: 135, color: '#a6e5b2' },
 r: { name: 'Egida', description: 'Scudo per te e il team vicino: -60% danni per 5 secondi.', cost: 35, cooldown: 14, range: 150, damage: 0, kind: 'shield', targeting: 'self', radius: 150, duration: 5, color: '#ffecb0' }
 } },
hunter: { 
    ...
    abilities: {
      ...
      e: { name: 'Scatto silvano', description: 'Balzo rapido nella direzione di puntamento.', cost: 0, cooldown: 6.5, range: 220, damage: 0, kind: 'dash', targeting: 'directional', radius: 25, color: '#c3ffd0' },
      r: { name: 'Tempesta di frecce', description: 'Scaglia in rapida sequenza 6 frecce attorno a te a 360 gradi.', cost: 45, cooldown: 11, range: 520, damage: 25, kind: 'area', targeting: 'self', speed: 500, radius: 7, color: '#8de8a3' }
    } 
  }
};
