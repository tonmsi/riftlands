...
- Durante uno scontro attivo, nemici, compagni arrivati dopo la partenza e partecipanti eliminati possono entrare nelle caselle blu. Il server verifica l'ingombro del personaggio: se entra nell'area riservata viene spostato al punto di espulsione esterno già previsto dal dungeon. Dipingi un accesso continuo e abbastanza largo dall'ingresso. Senza zone blu resta il comportamento precedente: espulsione di tutti gli estranei dalla regione dello scontro.
